            ...
            <div className='bug03__container'>
                ...
                <ul>
                    ...
                    <li>2.Make sure you have the necessary  about the part of the application you are testing. If you are not sure, ask business analyst, project manager, mentor, co-worker...
                        You MUST know how the application is suppose to be working,</li>
                    ...
                    <li>
                        5.Write a happy path test with appropriate test steps and descriptions,
                    </li>
                    <li>
                        6.Add validation testing and try to think of a scenario (several test steps) which could potentiality break the functionality,
                    </li>
                    <li>
                        7.When the feature is not working as it's suppose to work, that is called a bug. Make sure you log the bug and add the precise steps so the developers can reproduce it,
                    </li>
                    <li>
                        8.Once the bug is fixed, always re-test it.
                    </li>
                </ul>
                <marquee>You should check also the confluence page for more info: <a target="_blank" href='https://confluence.endava.com/display/TD/Induction+into+testing+discipline'>Confluence Page</a></marquee>
            </div>
    )
}